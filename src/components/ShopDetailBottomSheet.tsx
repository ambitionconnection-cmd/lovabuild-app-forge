        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h2 className="text-base font-bold text-white truncate">{shop.name}</h2>
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto overscroll-contain">
          ...
          <div className="px-4 py-3 flex gap-2">
            ...
            <Button
              ...
              variant="outline"
              className="flex-1 h-10 text-sm font-semibold border-white/10 text-white hover:bg-white/5"
            >
          ...
          {brandDescription && (
            <div className="px-4 py-2">
              <h3 className="text-sm font-semibold text-white mb-1.5">About {brand?.name || 'the Brand'}</h3>
          ...
          {shopDescription && shopDescription !== brandDescription && (
            <div className="px-4 py-2">
              <h3 className="text-sm font-semibold text-white mb-1.5">About this location</h3>
          ...
          <div className="px-4 py-3 flex flex-col gap-2">
            {brand?.official_website && (
              <a href={brand.official_website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                ...
                <span className="text-sm text-white">Official Website</span>
            ...
            {shop.official_site && shop.official_site !== brand?.official_website && (
              <a href={shop.official_site} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                <Globe className="w-4 h-4 text-[#C3C9C9]" />
                <span className="text-sm text-white">Shop Website</span>
                <ExternalLink className="w-3.5 h-3.5 text-white/40 ml-auto" />
              </a>
            )}
            {brand?.instagram_url && (

        ...
        <div className="lg:max-w-2xl space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-foreground/70 leading-relaxed">
              <strong className="text-foreground">FLYAF is the streetwear discovery platform that puts every shop and brand on your map.</strong>{" "}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-foreground/50">Use the interactive map to discover 200+ shops across 12+ cities, with real-time brand pins and distances.</p>
              </div>
              <div>
                <p className="text-sm text-foreground font-medium">Plan</p>
                <p className="text-xs text-foreground/50">Build a custom route on your desktop, then walk it on your phone. Never miss a store again.</p>
              </div>
              <div>
                <p className="text-sm text-foreground font-medium">Connect</p>
                <p className="text-xs text-foreground/50">Post your 'fit checks' to the HOT feed, tag the brands you're wearing, and see what the culture is wearing from Paris to Tokyo.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-foreground/70 leading-relaxed">
              FLYAF was born from a simple frustration: streetwear shops are everywhere but hard to find. We aren't a faceless tech company; we're built by people who spent a decade on the door.
            </p>
            <div className="space-y-2">
              <p className="text-sm text-foreground/60"><strong className="text-foreground">Global Reach:</strong> 150+ brands, 200+ shops, 12+ cities.</p>
              <p className="text-sm text-foreground/60"><strong className="text-foreground">Your Language:</strong> Navigate in 8 languages, including Japanese, Chinese, and Korean.</p>
              <p className="text-sm text-foreground/60"><strong className="text-foreground">Community First:</strong> A dedicated space to discover and be discovered.</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-foreground/70 leading-relaxed">
              Got feedback, want to submit a brand, or interested in becoming a FLYAF Ambassador? We'd love to hear from you.
            </p>
            <button
